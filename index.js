...
function CheckHaveSame(position,treeX,treeY)//判斷是否有重疊
{
    ...
    for(let i in Pointlist){
        ...
        console.log('treeDistanceSquared',treeDistanceSquared);
        console.log('radiusSumSquared',radiusSumSquared);
